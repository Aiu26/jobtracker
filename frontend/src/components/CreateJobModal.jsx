...
import { IconChevronDown, IconCalendar, IconArrowDown, IconArrowRight } from '@tabler/icons-react';
...
const CreateJobModal = ({ opened, onClose }) => {
  ...
  const onSubmit = async (data) => {
    // Manual validation
    if (!data.jobTitle || !data.location || !data.jobType || !data.companyName || 
        !data.applicationDeadline || !data.jobDescription || 
                 ...
                 <div>
                   ...
                   <Group gap="xs" align="center" style={{ flexWrap: 'nowrap' }}>
                     <NumberInput
                       ...
                       onChange={(value) => setValue('minSalary', value)}
                       style={{ flex: 1 }}
                     ...
                     />
                     <Text size="sm" c="dimmed" style={{ margin: '0 12px', whiteSpace: 'nowrap' }}>
                       to
                     </Text>
                     <NumberInput
                       ...
                       onChange={(value) => setValue('maxSalary', value)}
                       style={{ flex: 1 }}
                 ...
                 <div>
                   <Text size="sm" fw={500} mb={8}>
                     Application Deadline
                       ...
                       rightSection={<IconCalendar size={16} color="#6c757d" />}
